...
mdaJX10::mdaJX10(audioMasterCallback audioMaster) : AudioEffectX(audioMaster, NPROGS, NPARAMS)
{
	...
	if(programs)
	{
		...
		fillpatch(i++, "Just Saw", 0.00f, 0.37f, 0.25f, 0.00f, 0.00f, 0.00f, 1.00f, 0.00f, 0.12f, 0.00f, 0.50f, 0.90f, 0.89f, 0.90f, 0.73f, 0.00f, 0.50f, 1.00f, 0.71f, 0.00f, 0.00f, 0.00f, 0.50f, 0.50f);
